...
public class SnowShoesModel<T extends LivingEntity> extends HumanoidModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rightshoe = right_leg.addOrReplaceChild("rightshoe", CubeListBuilder.create()
		.texOffs(1, 0).addBox(-4.0F, 0.0F, 6.0F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition leftshoe = left_leg.addOrReplaceChild("leftshoe", CubeListBuilder.create()
		.texOffs(1, 0).addBox(-4.0F, 0.0F, 6.0F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(41, 28).addBox(-6.0F, 0.0F, 2.0F, 8.0F, 0.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(8, 7).addBox(-6.0F, 0.0F, -4.0F, 8.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
		.texOffs(1, 0).addBox(-4.0F, 0.0F, -7.0F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F))
